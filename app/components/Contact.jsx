...
const Contact = (isDarkMode) => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "11a81917-d093-429b-bc60-b0f8088e70d6");
  ...
  return (
    <motion.div
      ...
      <motion.p initial={{ y: -20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ duration: 0.5, delay: 0.7 }} className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">
        Let’s collaborate! Reach out for inquiries, projects, or just to say hello. I’d love to hear from you
      </motion.p>
      ...
      <motion.form initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.9 }} onSubmit={onSubmit} className="max-w-2xl mx-auto">
        <div className="grid grid-cols-auto gap-6 mt-10 mb-8">
          ...
          <motion.input
            ...
            className="flex-1 p-3 outline-none border-[0.5px] border-gray-400 rounded-md bg-white dark:bg-darkHover/30 dark:border-white/90"
            type="email"
            placeholder="jamesbond007@gmail.com"
            required
            name="email"
          />
        </div>
