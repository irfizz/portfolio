  ...
  return (
    <div className="w-full max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
      <motion.div
        ...
        className="items-center pb-5 px-4">
        <p className="italic text-lg sm:text-2xl md:text-3xl font-Ovo max-w-xs sm:max-w-lg break-words">
      ...
      <motion.h3
        ...
        whileInView={{ y: 0, opacity: 1 }}
        transition={{ duration: 0.6, delay: 0.3 }}
        className="flex items-end gap-2 text-xl md:text-2xl font-Ovo pb-5 pt-2">
      ...
      <motion.p
        ...
        Former business owner with expertise in operations, financial management, and competitive analysis.
        Transitioning into front-end development with strong problem-solving, time management, and self-taught
        programming skills.
      </motion.p>
      <motion.div
